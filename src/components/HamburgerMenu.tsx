...
export const HamburgerMenu = ({ isOpen }: HamburgerMenuProps) => {
  return (
    <div
      className={`fixed right-0 top-0 z-20 flex h-full flex-col gap-8 border-l border-neutral-200 bg-neutral-200/10 px-8 pt-16 leading-relaxed backdrop-blur-2xl transition-transform duration-300 ease-in-out ${
