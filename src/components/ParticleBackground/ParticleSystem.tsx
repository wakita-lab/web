  ...
  useFrame(() => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      const diff = new THREE.Vector3(
        (noise2D(pos.x * noiseDensity, (pos.y + eps) * noiseDensity) - noise2D(pos.x * noiseDensity, (pos.y - eps) * noiseDensity)) / (2 * eps),
        -(noise2D((pos.x + eps) * noiseDensity, pos.y * noiseDensity) - noise2D((pos.x - eps) * noiseDensity, pos.y * noiseDensity)) / (2 * eps),
        0,
